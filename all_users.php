...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="bank.html">GRIP</a>
...
while($row = $result->fetch_assoc()) {
  ...
  echo "<td><a href=transfer.php><button type= btn  class= btn btn-primary >pay again</button></a></td>";

  echo "</tr>";
/* echo "<tr><td>" . $row["user"]. "</td><td>" . $row["name"] . "</td><td>"
. $row["num"]. "</td></tr>";*/
}
echo "</table>";
echo '</div>';
...
/* $result = mysqli_query($conn,"select * from transictions");
